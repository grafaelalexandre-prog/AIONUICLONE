...
interface SiderAgentTasksEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderAgentTasksEntry: React.FC<SiderAgentTasksEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('agentTasks.label')} position='right'>
        <div
...
export default SiderAgentTasksEntry;